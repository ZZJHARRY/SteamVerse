...
export default function AlbumsPage() {
  ...
  return (
    ...
    // TODO (TASK 22): then uncomment the code to display the cover image and once again observe the change, i.e. what happens to the layout now that each album card has a fixed width? They stay 3 in a row nicely, evenly spaced
